...
export const metadata = { title: 'Terms of Service | DANAROUTE' }
    ...
    <div className="flex min-h-screen flex-col bg-[#FAFAFA] text-[#111827]" style={{ fontFamily: "'Manrope', 'Inter', sans-serif" }}>
      <header style={{ position: 'sticky', top: 0, zIndex: 50, backdropFilter: 'blur(24px)', background: 'rgba(250,250,250,0.85)', borderBottom: '1px solid #E5E7EB' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 24px', height: '72px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Link href="/" style={{ fontWeight: 900, fontSize: '20px', letterSpacing: '0.08em', color: '#111827', textDecoration: 'none' }}>DANAROUTE</Link>
      ...
      <main style={{ flex: 1, maxWidth: '800px', margin: '0 auto', padding: '80px 24px', width: '100%' }}>
        ...
        <div style={{ fontSize: '16px', color: '#4B5563', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <p>Welcome to DANAROUTE. By accessing or using our application, you agree to comply with and be bound by the following terms.</p>
          
          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#111827', marginTop: '16px' }}>1. Acceptance of Terms</h2>
          <p>By registering for an account or using DANAROUTE, you confirm that you accept these Terms of Service. If you do not agree to these terms, you must not use our services.</p>
          
          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#111827', marginTop: '16px' }}>2. User Responsibilities</h2>
          <p>You are responsible for maintaining the security of your account, passwords, and multi-factor authentication methods. You agree that DANAROUTE cannot and will not be liable for any loss or damage from your failure to comply with this security obligation or from unauthorized access to your account due to your own negligence.</p>
          
          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#111827', marginTop: '16px' }}>3. Service Availability and Changes</h2>
          <p>We are constantly improving DANAROUTE. We reserve the right to modify, suspend, or discontinue the service (or any part thereof) with or without notice at any time. We shall not be liable to you or to any third party for any modification, price change, suspension, or discontinuance of the service.</p>

          <h2 style={{ fontSize: '24px', fontWeight: 800, color: '#111827', marginTop: '16px' }}>4. Financial Advice Disclaimer</h2>
          <p>DANAROUTE provides tools and AI-driven insights to help you track and manage your finances. However, none of the information provided by the software constitutes professional financial, tax, or legal advice. You are solely responsible for your financial decisions.</p>
        </div>
      </main>
