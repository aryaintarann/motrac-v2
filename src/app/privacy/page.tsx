...
export const metadata = { title: 'Privacy Policy | DANAROUTE' }
    ...
    <div className="flex min-h-screen flex-col bg-[#FAFAFA] text-[#111827]" style={{ fontFamily: "'Manrope', 'Inter', sans-serif" }}>
      ...
      <main style={{ flex: 1, maxWidth: '800px', margin: '0 auto', padding: '80px 24px', width: '100%' }}>
        ...
        <div style={{ fontSize: '16px', color: '#4B5563', lineHeight: 1.8, display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <p>At DANAROUTE, we take your privacy seriously. This Privacy Policy explains how we collect, use, and protect your personal information when you use our personal finance application.</p>
          ...
          <p>Your data is strictly used to power your personal DANAROUTE dashboard, calculate budgets, and provide you with AI-driven financial insights. <strong>We do not sell, rent, or share your personal financial data to third-party advertisers.</strong></p>
